...
public class EventStatus : Enumeration {
    public static readonly EventStatus Draft
        = new EventStatus(0, "Draft");

    public static readonly EventStatus Ready
        = new EventStatus(1, "Ready");

    public static readonly EventStatus Active
        = new EventStatus(2, "Active");

    public static readonly EventStatus Cancelled
